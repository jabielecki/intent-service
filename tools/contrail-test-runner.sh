...
Usage()
{
	...
	echo 'This script will run sanity tests defined in https://github.com/tungstenfabric-preview/test'
	echo
...
prepare_test_env()
{
	...
	[ ! -e ./testrunner.sh ] && { wget https://github.com/tungstenfabric-preview/test/raw/master/testrunner.sh || echo "Could not download testrunner script from https://github.com/tungstenfabric-preview/test/raw/master/testrunner.sh"; }
